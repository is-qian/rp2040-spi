...
enum {
    MP_QSTR_rp2_dot_py = MP_QSTRnumber_of,
    MP_QSTR_PIOASMError,
    MP_QSTR_PIOASMEmit,
    MP_QSTR_gpio,
    MP_QSTR_pins,
...
const qstr_pool_t mp_qstr_frozen_const_pool = {
    ...
    184, // used entries
    {
        ...
        (const byte*)"\x38\x0a" "setsockopt",
        (const byte*)"\x0f\x0a" "SOL_SOCKET",
        (const byte*)"\x21\x0c" "SO_REUSEADDR",
        (const byte*)"\x84\x04" "bind",
        (const byte*)"\xcc\x06" "listen",
        (const byte*)"\x85\x06" "accept",
...
STATIC const byte fun_data__boot__lt_module_gt_[160] = {
    0x3c, 0x1c,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR__boot_dot_py & 0xff, MP_QSTR__boot_dot_py >> 8,
    0x28, 0x78, 0x40, 0x2b, 0x23, 0x59, 0x36, 0x39, 0x4f, 0x00,
    0x80, 
    0x51, 
...
STATIC const byte fun_data_uasyncio_core__lt_module_gt__run_until_complete[293] = {
    0xf1, 0x03, 0x0a,
...
STATIC const byte fun_data_uasyncio_stream__lt_module_gt__open_connection[129] = {
    0xea, 0x42, 0x0a,
