...
QDEF(MP_QSTR_AUTH_OPEN, (const byte*)"\x46\x09" "AUTH_OPEN")
QDEF(MP_QSTR_AUTH_WEP, (const byte*)"\xf0\x08" "AUTH_WEP")
QDEF(MP_QSTR_AUTH_WPA2_PSK, (const byte*)"\xf1\x0d" "AUTH_WPA2_PSK")
QDEF(MP_QSTR_AUTH_WPA_PSK, (const byte*)"\xc3\x0c" "AUTH_WPA_PSK")
QDEF(MP_QSTR_AUTH_WPA_WPA2_PSK, (const byte*)"\xe8\x11" "AUTH_WPA_WPA2_PSK")
...
QDEF(MP_QSTR_ESP8266, (const byte*)"\x89\x07" "ESP8266")
...
QDEF(MP_QSTR_WLAN_SPI, (const byte*)"\xa4\x08" "WLAN_SPI")
QDEF(MP_QSTR_WLAN_UART, (const byte*)"\xdc\x09" "WLAN_UART")
...
QDEF(MP_QSTR_hostname, (const byte*)"\xc2\x08" "hostname")
...
QDEF(MP_QSTR_mqtt_client_id, (const byte*)"\x0d\x0e" "mqtt_client_id")
QDEF(MP_QSTR_mqtt_data, (const byte*)"\x16\x09" "mqtt_data")
QDEF(MP_QSTR_mqtt_keepalive, (const byte*)"\x0a\x0e" "mqtt_keepalive")
QDEF(MP_QSTR_mqtt_password, (const byte*)"\x99\x0d" "mqtt_password")
QDEF(MP_QSTR_mqtt_port, (const byte*)"\xdf\x09" "mqtt_port")
QDEF(MP_QSTR_mqtt_qos, (const byte*)"\x8b\x08" "mqtt_qos")
QDEF(MP_QSTR_mqtt_retain, (const byte*)"\xa3\x0b" "mqtt_retain")
QDEF(MP_QSTR_mqtt_server, (const byte*)"\x43\x0b" "mqtt_server")
QDEF(MP_QSTR_mqtt_ssl, (const byte*)"\x8a\x08" "mqtt_ssl")
QDEF(MP_QSTR_mqtt_ssl_params, (const byte*)"\xe9\x0f" "mqtt_ssl_params")
QDEF(MP_QSTR_mqtt_topic, (const byte*)"\x67\x0a" "mqtt_topic")
QDEF(MP_QSTR_mqtt_user, (const byte*)"\xd7\x09" "mqtt_user")
